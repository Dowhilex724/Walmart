...
$(function(){
	new  Slideshow({
		boxId:"#banner",
		imgs:["images/lunbo1.jpg","images/lunbo2.jpg","images/lunbo3.jpg","images/lunbo4.jpg","images/lunbo5.jpg","images/lunbo6.jpg"],
		width:1200,
		height:400,
		timeSpace:3000,
		fadeInOutTime:1500,
...
Slideshow.prototype.initUI = function(){
	...
	//2、所有按钮的创建
	let ulliStr = "<ul style='position:absolute;right:500px;bottom:20px;z-index:999;display:flex;justify-content:space-between'>";
	
	for(let i=0;i<this.imgs.length;i++){
		ulliStr +="<li ord='"+(i+1)+"' style='border:2px solid #fff; list-style:none;float:left;margin:10px;width:"+this.btnWidth+"px;height:"+this.btnHeight+"px;border-radius:50%;text-align:center;background-color:"+this.btnColor+";'></li>"
	}
	ulliStr +="</ul>";
